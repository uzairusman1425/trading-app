...
export default function(){
    return(
        <>
        <section className="w-screen h-screen  flex items-center justify-center bg-[#1d1d27]">
            <div className="login card w-[500px] h-[700px] bg-white flex flex-col gap-4 items-center justify-start pt-10   shadow-2xl  rounded-lg ">
